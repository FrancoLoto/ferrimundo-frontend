...
const Servicios = () => {
    return (
        <section className="max-w-8xl mx-auto container bg-white pt-16 pb-16">
                    <div>
                        <div role="contentinfo" className="flex items-center flex-col px-4">
                            ...
                            <h1 tabIndex={0} className="focus:outline-none text-4xl lg:text-4xl font-extrabold text-center leading-10 text-gray-800 lg:w-5/12 md:w-9/12 pt-4 text-focus-in">Create Beautiful Landing Pages & Web Apps in a Jiffy</h1>
                        </div>
                        <div tabIndex={0} aria-label="group of cards" className="focus:outline-none mt-20 flex flex-wrap justify-center gap-10 px-4">
                            <div tabIndex={0} aria-label="card 1" className="focus:outline-none flex sm:w-full md:w-5/12 pb-20">
                                <div className="w-20 h-20 relative mr-5">
                                    <div className="absolute top-0 right-0 bg-red-100 rounded w-16 h-16 mt-2 mr-1"></div>
                                    <div className="absolute text-white bottom-0 left-0 bg-red-90 rounded w-16 h-16 flex items-center justify-center mt-2 mr-3">
