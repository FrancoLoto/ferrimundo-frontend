    ...
    return(
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="lg:w-10/12 w-full">
                <p className="leading-3 text-indigo-700 hover:text-indigo-800 cursor-pointer">About</p>
                <h2 className="bold-32 lg:bold-40 lg:leading-10 leading-9 mt-2 text-focus-in">We are here to make great design accessible and delightfull for everyone</h2>
            ...
            <div className="lg:mt-16 sm:mt-12 mt-16 flex lg:flex-row justify-between flex-col lg:gap-8 gap-12">
                <div className="w-full xl:w-5/12 lg:w-6/12">
                    <h2 className="bold-32 lg:bold-40 lg:text-4xl text-3xl lg:leading-9 leading-7">Nuestra historia</h2>
